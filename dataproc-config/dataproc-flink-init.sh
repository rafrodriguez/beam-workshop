...
function install_flink() {
  readonly local url='http://www-us.apache.org/dist/flink/flink-1.3.2/flink-1.3.2-bin-hadoop27-scala_2.10.tgz'
  readonly local tarball='flink-1.3.2-bin-hadoop27-scala_2.10.tgz'
  readonly local extract_dir='flink-1.3.2'
